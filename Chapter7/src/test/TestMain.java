...
public class TestMain {
	...
	public void createStudent() {
		...
		Student student1 = new Student(211213, "김강찬", korean);
		...
		addScoreForStudent(student1, korean, 85);
		addScoreForStudent(student1, math, 56);
		
		addScoreForStudent(student1, dance, 95);
		addScoreForStudent(student1, dance, 85);
		addScoreForStudent(student1, dance, 55);
	}
